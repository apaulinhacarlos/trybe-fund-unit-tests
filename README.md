...
Neste projeto eu implementei várias funções para atender aos requisitos propostos e/ou testes unitários para garantir que as implementações das funções estavam corretas.
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-fund-unit-tests.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-fund-unit-tests
```
